...
openai.apiKey = "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"

function SendChatGPT(text) {
    //sendTextMessage(text);
    var predefined_text="You are a chatbot made by Adit, Ravi and Sreemanth. Introduce yourself as HAL and and greet the user and respond to their queries.";
    ...
    var OPENAI_API_KEY = "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";
...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Hello there 👋🏻,<br><br>My name is <span class='bold'><a class='alink'>HAL 900</a>.</span><br><br>I am a chatbot made by <span class='bold'>Team 12.</span><br>");
            }, 2000);
            break;
        case "new":
